...
import com.snapnstore.adapters.VideoAdapter
import com.snapnstore.utils.FileData
import com.snapnstore.databinding.ActivitySelectVideoBinding
...
class SelectVideoActivity : AppCompatActivity() {
    ...
    private fun showVideoDetails() {
        Log.d(SelectVideoActivity::class.java.name, "showVideoDetails: $fileUri")
        ...
        fileUri?.let { uri ->
            ...
            try {
                ...
                Log.e(SelectVideoActivity::class.java.name, "showVideoDetails: ${e.localizedMessage}")
            } finally {
                cursor?.close()
                retriever.release()
            }
