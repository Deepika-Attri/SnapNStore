...
import com.snapnstore.adapters.ImageAdapter
import com.snapnstore.utils.FileData
import com.snapnstore.utils.projection
import com.snapnstore.utils.toReadableFileSize
import com.snapnstore.databinding.ActivitySelectImageBinding
...
class SelectImageActivity : AppCompatActivity() {
            ...
            result?.let { list ->
                ...
                list.forEach { uri ->
                    ...
                    try {
                        ...
                        Log.e(
                            SelectImageActivity::class.java.name,
    ...
    private fun showImageDetails(uri: Uri) {
        Log.d(SelectImageActivity::class.java.name, "showImageDetails: $uri")
        ...
        try {
            ...
            parcelFileDescriptor?.let {
                ...
                Log.d(SelectImageActivity::class.java.name, "showImageDetails: width: $width")
                Log.d(SelectImageActivity::class.java.name, "showImageDetails: height: $height")
            }

        } catch (e: Exception) {
            Log.e(SelectImageActivity::class.java.name, "showImageDetails: ${e.localizedMessage}")
        } finally {
            cursor?.close()
